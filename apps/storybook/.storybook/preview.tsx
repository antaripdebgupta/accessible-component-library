...
const withTheme: Decorator = (Story, context) => {
  ...
  if (theme === "both") {
    return (
      <div className="min-h-screen bg-slate-100 dark:bg-slate-900 p-6 flex flex-col xl:flex-row gap-6">
        {/* Light */}
  ...
  return (
    <div className={isDark ? "dark" : undefined}>
      <div
        className={`min-h-screen flex items-center justify-center p-8 transition-colors ${isDark
